...
// const UserMenu = () => {
//   const { user, isAuthenticated, signOut } = useUser(); // Use useUser hook
//   const [isOpen, setIsOpen] = useState(false);
//   const dropdownRef = useRef(null);
//   const navigate = useNavigate();

//   // Force re-render when user or avatar changes
//   useEffect(() => {
//     // No action needed, just ensure re-render
//   }, [user?.avatar]);
...
//     { label: 'Preferences', path: '/user-preferences', icon: 'Settings', description: 'Customize your experience' },
//     { label: 'Notifications', path: '/user-notifications', icon: 'Bell', description: 'Manage notifications' },
//   ];
...
//   // Null check for user
//   if (!user) {
//     return <div>Loading user data...</div>; // Placeholder while user data loads
//   }
