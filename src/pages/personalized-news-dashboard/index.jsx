...
//   });
//   const [showOnboardingForm, setShowOnboardingForm] = useState(location.pathname === '/personalized-news-dashboard/onboarding');
...
//     console.log('Navigating to /personalized-news-dashboard');
...
//       <GlobalHeader />
//       {/* {showLocationForm && (
//         <LocationSelectForm onDone={() => setShowLocationForm(false)} />
//       )} */}
...
//         />
//       )}
//       {/* {userData?.role === 'user' && userData?.reporterFormSubmitted && !showOnboardingForm && (
...
//               Thank you, {userData?.name}! Your reporter application is pending admin approval.
//             </p>
...
//         </div>
//       )}
//       {/* Responsive row for category chips and Post News button */}
//       <div
//         className="flex items-center gap-2 px-2 sm:px-4 mt-4 w-full"
//         style={{
//           flexWrap: 'nowrap',
//           overflowX: 'auto',
...
//           <Button
//             variant="primary"
//             className="ml-2 whitespace-nowrap px-3 py-2 text-sm sm:text-base"
//             style={{ minWidth: 110 }}
...
//         </div>
//       </div>
//       {/* BreakingNewsBanner always below category chips */}
//       <BreakingNewsBanner />
//       {/* Main content and sidebar layout */}
//       <div className="flex flex-col lg:flex-row w-full max-w-full">
//         <main className="flex-1 ml-0 sm:ml-2 lg:ml-4 transition-all duration-300 min-w-0">
...
//           </PullToRefresh>
//         </main>
//         <div className="hidden lg:block w-full max-w-xs min-w-[16rem] ml-0 lg:ml-4 mt-4 lg:mt-0">
//           <TrendingSidebar
...
//         </div>
//       )}
//       {/* Back to top button, only visible on scroll and mobile-friendly */}
//       <Button
//         variant="secondary"
//         onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
//         className="fixed bottom-20 left-4 w-10 h-10 sm:bottom-24 sm:left-6 sm:w-12 sm:h-12 rounded-full shadow-modal opacity-0 hover:opacity-100 transition-opacity duration-300 lg:opacity-100 z-50"
