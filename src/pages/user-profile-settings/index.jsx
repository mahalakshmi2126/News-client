...
//   const { user, isAuthenticated, setUser, refreshUserData } = useContext(UserContext);
...
//   useEffect(() => {
//     console.log('UserContext:', { user, isAuthenticated });
...
//     checkAuth();
//   }, [navigate, isAuthenticated]); // Removed refreshUserData from dependencies to avoid loop
...
//       //       settings={user.settings.notificationSettings}
//       //       onUpdateSettings={(settings) => handleUpdateSettings('notificationSettings', settings)}
//       //     />
//       //   );
//       // case 'privacy':
//       //   return user.settings?.privacySettings && (
//       //     <PrivacySettings
//       //       settings={user.settings.privacySettings}
//       //       onUpdateSettings={(settings) => handleUpdateSettings('privacySettings', settings)}
//       //     />
//       //   );
//       default:
//         return null;
...
//           ) : (
//             <>
//               {activeTab === 'profile' && <div className="p-4"><ProfileHeader user={user} onUpdateProfile={handleUpdateProfile} /></div>}
//               <div className="px-4 pb-4">
//                 {user.settings?.notificationSettings && (
//                   <SettingsSection title="Notifications" icon="Bell" defaultExpanded={activeTab === 'notifications'}>
//                     <NotificationSettings
//                       settings={user.settings.notificationSettings}
//                       onUpdateSettings={(settings) => handleUpdateSettings('notificationSettings', settings)}
//                     />
...
//                   <SettingsSection title="Privacy & Data" icon="Shield" defaultExpanded={activeTab === 'privacy'}>
//                     <PrivacySettings
//                       settings={user.settings.privacySettings}
//                       onUpdateSettings={(settings) => handleUpdateSettings('privacySettings', settings)}
//                     />
